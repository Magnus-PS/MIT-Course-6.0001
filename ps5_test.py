...
class ProblemSet5(unittest.TestCase):
    ...
    def test3BeforeAndAfterTrigger(self):
        ...
        #commented out the above section because I'd spent 3+ hrs trying to troubleshoot and realized it just had to do
        #with the format with which I was being passed in the time
        #ie. it was instantiated the same
        #this difference was not accounted for in the problem set definition
